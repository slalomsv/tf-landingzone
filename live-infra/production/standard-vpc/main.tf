...
module "security_group_ssh_private" {
  ...
  vpc_name         = "${var.vpc_name}"
  vpc_id           = "${module.prod_standard_vpc.vpc_id}"
  local_vpc_cidr   = "${module.prod_standard_vpc.vpc_cidr}"
...
module "management_vpc_peering" {
  ...
  dmz_route_table_id      = "${module.prod_standard_vpc.dmz_route_table_id}" 
  app_route_table_id      = "${module.prod_standard_vpc.app_route_table_id}"
  data_route_table_id     = "${module.prod_standard_vpc.data_route_table_id}"
