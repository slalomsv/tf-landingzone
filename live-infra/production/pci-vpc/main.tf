...
module "security_group_ssh_private" {
  ...
  vpc_name         = "${var.vpc_name}"
  vpc_id           = "${module.prod_pci_vpc.vpc_id}"
  local_vpc_cidr   = "${module.prod_pci_vpc.vpc_cidr}"
...
module "management_vpc_peering" {
  ...
  vpc_name                = "${module.prod_pci_vpc.vpc_name}"
  vpc_id                  = "${module.prod_pci_vpc.vpc_id}"
  vpc_cidr                = "${module.prod_pci_vpc.vpc_cidr}"
  dmz_route_table_id      = "${module.prod_pci_vpc.dmz_route_table_id}" 
  app_route_table_id      = "${module.prod_pci_vpc.app_route_table_id}"
  data_route_table_id     = "${module.prod_pci_vpc.data_route_table_id}"
...
module "bastion_asg" {
  ...
  asg_subnets        = "${module.prod_pci_vpc.dmz_subnet_1_id},${module.prod_pci_vpc.dmz_subnet_2_id}"
  max_size           = 3
  desired_capacity   = 2
  min_size           = 1
}
...
module "example_ws" {
  ...
  asg_subnets         = "${module.prod_pci_vpc.app_subnet_1_id},${module.prod_pci_vpc.app_subnet_2_id}"
  elb_subnets         = "${module.prod_pci_vpc.dmz_subnet_1_id},${module.prod_pci_vpc.dmz_subnet_2_id}"
  key_name            = "${data.terraform_remote_state.key_pairs.main_key_name}"
  max_size            = 3
  desired_capacity    = 2
  min_size            = 1
